...
-- Auto-generated by thinkup/extras/scripts/migratedb script on 2012-02-21
--

ALTER DATABASE DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

--
-- Table structure for table tu_active_users
--

CREATE TABLE tu_active_users (
  instance_id int(11) NOT NULL,
  date date NOT NULL,
  period enum('day','week','month','days_28') COLLATE utf8_bin NOT NULL DEFAULT 'day',
  count int(10) unsigned NOT NULL,
  last_updated timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  UNIQUE KEY instance_date (instance_id,date,period),
...
CREATE TABLE tu_posts (
  ...
  last_updated timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT 'Last time this post was updated (or first inserted)',
  PRIMARY KEY (id),
...
-- Dump completed on 2012-02-21 16:49:24
