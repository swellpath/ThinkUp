...
-- Auto-generated by thinkup/extras/scripts/migratedb script on 2011-10-18
--

ALTER DATABASE DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci;

--
-- Table structure for table tu_domains
--

CREATE TABLE tu_domains (
...
--
-- Table structure for table tu_referrals
--

CREATE TABLE tu_referrals (
  instance_id int(11) NOT NULL,
  domain_id bigint(20) unsigned NOT NULL,
  date date NOT NULL,
  referrals int(10) unsigned NOT NULL,
  UNIQUE KEY instance_id (instance_id,domain_id,date)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_bin;
...
-- Dump completed on 2011-10-18 20:00:01
