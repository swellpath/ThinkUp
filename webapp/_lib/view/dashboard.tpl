        ...
        {if $instance}
            ...
            {else} <!-- else if $data_template -->
              ...
              {if $follower_count_history_by_day.history && $follower_count_history_by_week.history}
                ...
                <script>
                  var follower_history_by_day_data = {$follower_count_history_by_day.ccc_data};
                  var follower_history_by_week_data = {$follower_count_history_by_week.ccc_data};
                  ...
                  var line1 = new pvc.LineChart({
                    ...
                    yAxisSize: 30,
                    extensionPoints: {
                      noDataMessage_text: "missing data",
                      xAxisScale_dateTickFormat: "%m/%d",
                      xAxisScale_dateTickPrecision: 798336000/10
                                //set in miliseconds
                    }
                  });
                  line1.setData(follower_history_by_day_data,
                    {crosstabMode: false,
                    seriesInRows: false});
                  line1.render();
                  ...
                  var line2 = new pvc.LineChart({
                    ...
                    yAxisSize: 30,
                    extensionPoints: {
                      noDataMessage_text: "with missing data",
                      xAxisScale_dateTickFormat: "%m/%d",
                      xAxisScale_dateTickPrecision: 798336000/1.5
                                //set in miliseconds
                    }
                  });
                  line2.setData(follower_history_by_week_data,
                    {crosstabMode: false,
                    seriesInRows: false});
                  line2.render();
                  {/literal}
                      ...
                      <div class="grid_8 alpha">
                          ...
                          var post_types = {
                              "resultset":[
                                  ...
                                  ["","Broadcaster", links]],
                               "metadata":[{"colIndex":0,"colType":"String","colName":"Series"},{"colIndex":1,"colType":"String","colName":"Categories"},{"colIndex":2,"colType":"Numeric","colName":"Value"}]};
                          var bar1 = new pvc.BarChart({
                            ...
                            animate:true,
                            extensionPoints: {
                              xAxisScale_tickFormat: "%d%%",
                            }
                          });

                          bar1.setData(post_types,
                              {crosstabMode: false,
                               seriesInRows: false});
                          bar1.render();
                          {/literal}
